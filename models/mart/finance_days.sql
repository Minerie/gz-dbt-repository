Select
    ...
    Round(Sum(logcost), 1) AS Total_log_cost,               -- Variable nécessaire : Log_cost
    ...
    Round(Sum(margin + shipping_fee - logcost - ship_cost ), 1) AS Operational_margin,-- Variable nécessaire : Revenue, Quantity, Purchase_price, Shipping_fee, Log_cost et Ship_cost
